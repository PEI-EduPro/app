...
async def create_question(
    ...
    question_option = QuestionOption(question_data)
...
async def update_question(
    ...
    # Update fields
    for key, value in question_option_data.items():
        if hasattr(question_option, key) and value is not None:
            setattr(question_option, key, value)
