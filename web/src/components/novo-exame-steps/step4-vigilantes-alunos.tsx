...
export function Step4VigilantesAlunos({
  form,
  studentsCsv,
  setStudentsCsv,
  onNext,
            ...
            render={({ field: { onChange }, fieldState: { error } }) => (
              <FormItem>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-1.5 items-start rounded-md bg-amber-50 border border-amber-200 px-2.5 py-2">
                          ...
                          <p className="text-xs text-amber-700 leading-snug">
                            ...
                            <code className="font-mono text-[10px]">nmec</code>{" "}
                ...
                <p className="text-xs text-muted-foreground">
                  Formato esperado: <code>nmec, nome, email</code> (uma linha
                  por aluno)
                </p>
                <FormControl>
                  <div
                ...
                {studentsCsv && !error && (
                  <p className="text-sm text-green-600">
                    {studentsCsv.name} carregado com sucesso.
                  </p>
                )}
              </FormItem>
            )}
            ...
            render={() => (
              <FormItem className="flex items-center justify-between">
                <FormLabel className="shrink-0 flex items-center gap-1">
                  Número de exames <span className="text-red-500">*</span>
                </FormLabel>
                <FormControl>
                  <Input
                  ...
                  <HelperHoverCard
                    ...
                    content={
                      <p className="text-xs text-gray-600 leading-relaxed">
                        ...
                        dos mesmos tópicos. Quando uma questão se repete, a{" "}
                        <span className="font-medium text-gray-800">
                        ...
                        , ou seja, 10 alunos terão exatamente o mesmo exame.
                      </p>
                    }
                  />
                </FormLabel>
