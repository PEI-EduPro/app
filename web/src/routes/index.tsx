...
function Index() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-12 md:gap-24 max-w-5xl w-full">
        <div className="flex flex-col items-center md:items-start gap-6 text-center md:text-left animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#41B5C0]/20 border border-[#41B5C0]/40 stagger-1 animate-fade-in-up">
            <span className="w-2 h-2 rounded-full bg-[#2E8B57] dark:bg-[#9EE78F] animate-pulse" />
            <span className="text-[#2E8B57] dark:text-[#9EE78F] text-sm font-medium">
              Plataforma de Avaliação
            </span>
          </div>

          <h1 className="font-rubik text-4xl md:text-6xl font-bold text-foreground dark:text-white leading-tight stagger-2 animate-fade-in-up">
            Bem-vind@ ao <span className="text-[#41B5C0]">EduPro</span>
          </h1>

          <p className="text-muted-foreground dark:text-[#E3F6A2]/80 text-lg md:text-xl leading-relaxed max-w-md stagger-3 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 stagger-4 animate-fade-in-up">
              <Button
                ...
                onClick={() =>
                  keycloak.login({
                    redirectUri: `https://bioinformatics.ua.pt/edupro/unidades-curriculares/`
                  })
                }
              >
                Entrar
            ...
            <p className="text-muted-foreground dark:text-[#E3F6A2]/60 text-sm">
              ...
              <a
                href="#"
                className="text-[#9EE78F] hover:text-[#41B5C0] dark:hover:text-[#E3F6A2] underline underline-offset-2"
                onClick={(e) => {
                  e.preventDefault();
                  keycloak.register({
                    redirectUri: `https://bioinformatics.ua.pt/edupro/unidades-curriculares/`
